...
public class MainAppNew122 extends Application {
    ...
    private void showMainWindow(Stage stage) {
        ...
        InputStream imageStream = getClass().getResourceAsStream("/job_background.jpg");
        if (imageStream != null) {
        ...
        titleLabel.setStyle("-fx-font-size: 50px; -fx-font-weight: bold; -fx-text-fill: white;");
    ...
    private void showJobSeekerWindow(Stage stage) {
        ...
        userPhoto.setClip(new Circle(30, 30, 30));
        ...
        Label greetingLabel = new Label("Welcome, " + currentUser.name);
    ...
    private VBox createJobCard(JobPosting posting) {
        ...
        Label salaryLabel = new Label("Salary: " + posting.salaryRange);
    ...
    private void showUserApplyWindow(Stage stage) {
        ...
        if (form != null) {
            ...
            submitButton.setOnAction(e -> {
                ...
                if (gpa.get() != null && !gpa.get().isEmpty() && !GPA_PATTERN.matcher(gpa.get()).matches()) {
                    showAlert("GPA must be a valid decimal number (e.g., 3.5).");
                    return;
                }
            ...
            formLayout.getChildren().addAll(
                    ...
                    phoneLabel, phoneField, cityLabel, cityField, countryLabel, countryField,
